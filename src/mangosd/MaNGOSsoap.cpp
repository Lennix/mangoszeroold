...
int ns1__executeCommand(soap* soap, char* command, char** result)
{
    ...
    // commands are executed in the world thread. We have to wait for them to be completed
    {
        ...
        CliCommandHolder* cmd = new CliCommandHolder(accountId, sAccountMgr.GetSecurity(accountId), &connection, command, &SOAPCommand::print, &SOAPCommand::commandFinished);
